...
namespace Paralect.Config.Settings.Test.Tests
{
    ...
    public class SettingsReaderTest
    {
        ...
        public void Test_Relative_Path_When_Settings_In_Same_Folder()
        {
            ...
            var pathToConfigFile = @"d:\git\paralect\Paralect.Config\source\Paralect.Config.Settings.Test\Data\.core.config";

            var processedSettingsPath = PathHelper.ProcessPossiblyRelativePath(relative, pathToConfigFile);
            Assert.AreEqual(processedSettingsPath, @"d:\git\paralect\Paralect.Config\source\Paralect.Config.Settings.Test\Data\settings");
        }
        ...
        public void Test_Relative_Path_When_Settings_At_The_Parrent_Folder()
        {
            ...
            var processedSettingsPath = PathHelper.ProcessPossiblyRelativePath(relative, pathToConfigFile);
            Assert.AreEqual(processedSettingsPath, @"d:\git\paralect\Paralect.Config\source\Paralect.Config.Settings.Test\settings");
        }
        ...
        public void Test_Relative_Path_When_Settings_Deeply()
        {
            ...
            var processedSettingsPath = PathHelper.ProcessPossiblyRelativePath(relative, pathToConfigFile);
            Assert.AreEqual(processedSettingsPath, @"d:\git\paralect\Paralect.Config\source\Paralect.Config.Settings.Test\Data\someSystem\settings");
        }
